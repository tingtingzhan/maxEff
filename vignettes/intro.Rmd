...
Users are encouraged to learn more about functions `grouped_ppp()` and `aggregate_quantile()` from the [**Introduction** vignette of package **`groupedHyperframe`**](https://cran.r-project.org/web/packages/groupedHyperframe/vignettes/intro.html).
