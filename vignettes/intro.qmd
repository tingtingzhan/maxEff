...
```{r}
#| code-fold: true
#| code-summary: 'Training models *`b0`*: 1st element'
b0[[1L]]
```

```{r}
#| code-fold: true
#| code-summary: 'Training models *`b0`*: 2nd element'
b0[[2L]]
```

```{r}
#| code-fold: true
#| code-summary: 'Training models *`c0`*: 1st element'
c0[[1L]]
```

```{r}
#| code-fold: true
#| code-summary: 'Training models *`c0`*: 2nd element'
c0[[2L]]
```
...
| [`.GlobalEnv`](https://search.r-project.org/R/refmans/base/html/environment.html) | Global environment |
