...
#| label: rpart
#| code-fold: true
#| code-summary: '**Review**: `rpart::rpart()`'
rp0 = rpart::rpart(
...
```{r}
#| code-fold: true
#| code-summary: '**Example**: application of dichotomizing rule *`D0`*'
...
```{r}
#| code-fold: true
#| code-summary: '**Review**: `base::print.function()`'
D0
```
...
```{r}
#| code-fold: true
#| code-summary: '**Advanced**: `eval`uate in *`environment(D0)`*, child of package `namespace`'
ev = environment(D0)
parent.env(ev)
...
```{r}
#| code-fold: true
#| code-summary: '**Example**: `labels.node1()`'
D0 |> 
  labels()
```
...
```{r}
#| code-fold: true
#| code-summary: '**Example**: `predict.node1()`'
stagec1$age
D0 |> 
...
```{r}
#| code-fold: true
#| code-summary: '**Example**: get_cutoff.node1()'
D0 |> 
  get_cutoff()
```
