...
Third, the `S3` method dispatch `sort_by.add_()` sorts the input by the `abs`olute value of regression coefficient (i.e., effect size) of the additional `logical` predictor.
...
-   `attr(., 'effsize')`, a `numeric` scalar, the regression coefficient, i.e., effect size, of the additional `numeric` predictor
...
-   `attr(., 'effsize')`, a `numeric` scalar, the regression coefficient, i.e., effect size, of the additional `logical` predictor
